...
\end{figure}
	...
	\end{equation*}
	This creates a grid of lines every tenth row and every tenth column, the \texttt{SNR = 3.61} (\cref{eq:SNR}). See \footnote{To recreate \cref{fig:BibGrid,fig:BibGridRec,fig:BibGridRec2}, run \texttt{ex2point34.m}} \cref{fig:BibGrid}.\\
