...
\end{figure}
	...
	\end{itemize}
	1500 different combinations were tested, only the best will be shown (for obvious reasons) \footnote{To run the tests and recreate \cref{fig:Bib,fig:Noisy,fig:RecBib,fig:CusBib}, run \texttt{ex2point2.m}, see \cref{lst:ex2point2}} \\
...
\begin{itemize}
	...
	\item ReverseBior (biorthogonal): \texttt{	"rbio1.1", "rbio1.3", "rbio1.5"
		...
		"rbio3.9", "rbio4.4", "rbio5.5", "rbio6.8"}
\end{itemize}
1500 different combinations were tested, only the best for the redundant scheme will be shown (for obvious reasons) \footnote{To run the tests and recreate \cref{fig:RecRed,fig:RecCus}, run \texttt{ex2point3.m}, see \cref{lst:ex2point3}}. The quality metric is \texttt{SNR} (The higher the better), see \cref{eq:SNR}.\\
